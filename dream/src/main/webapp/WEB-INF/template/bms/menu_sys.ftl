...
<body class="menu">
	<div class="body">
		<@shiro.hasAnyPermissions name="ROLE_SYSTEM_MENU">
			<dl>
				<dt>
					<span>系统管理</span>
				</dt>
				<@shiro.hasPermission name="ROLE_ADMIN_MANAGE">
					<dd>
						<a href="${base}/bms/admin!list.action" target="mainFrame">管理员列表</a>
					</dd>
				</@shiro.hasPermission>
				<@shiro.hasPermission name="ROLE_ROLE_MANAGE">
					<dd>
