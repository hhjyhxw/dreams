//通用返回顶部效果 
$.fn.add_gettop = function(){
	$("body").not(".noroll").append("<div id='roll'><span title='回到顶部' id='roll_top'>▲返回顶部</span></div>");
	$(window).scroll(function() {
		$("#roll").css("left",$(window).width()-99);
	...
	$("#roll_top").click(function(){$("html,body").animate({scrollTop: 0}, 800);});
	$("#roll_top").hover(function(){
		$(this).css({"background":"#ed4b39"});
	},function(){
